...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEQ_COMMENTS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 13 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEQ_POST_LIKES"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 70 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SEQ_POST_TAGS
--------------------------------------------------------

   CREATE SEQUENCE  "SEQ_POST_TAGS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 32 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SEQ_TAGS
--------------------------------------------------------

   CREATE SEQUENCE  "SEQ_TAGS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 24 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (6,'user01',9,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (7,'user01',8,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (8,'user01',7,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (9,'user01',6,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (1,'hong123',8,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (2,'hong123',7,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (3,'hong123',4,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (10,'hong123',11,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (11,'hong123',10,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (5,'hong123',6,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (12,'hong123',9,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (13,'kong123',10,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (14,'kong123',8,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (15,'kong123',6,to_date('26/06/09','RR/MM/DD'));
Insert into BOOKMARKS (BOOKMARK_ID,USER_ID,POST_ID,CREATED_AT) values (16,'kong123',7,to_date('26/06/09','RR/MM/DD'));
...
SET DEFINE OFF;
Insert into FOLLOWS (FOLLOWER_ID,FOLLOWING_ID,CREATED_AT) values ('hong123','kong123',to_date('26/06/09','RR/MM/DD'));
...
Insert into POSTS (POST_ID,USER_ID,TITLE,CONTENT,CODE_BLOCK,CREATED_AT,UPDATED_AT) values (13,'kong123','실시간 게시글 검색','입력한 키워드에 따라 게시글 목록을 실시간 필터링합니다.','const filteredPosts = posts.filter(post =>
...
Insert into POST_TAGS (POST_TAG_ID,POST_ID,TAG_ID) values (21,13,14);
Insert into POST_TAGS (POST_TAG_ID,POST_ID,TAG_ID) values (20,13,19);
Insert into POST_TAGS (POST_TAG_ID,POST_ID,TAG_ID) values (22,13,20);
...
Insert into USERS (USER_ID,EMAIL,PASSWORD_HASH,NICKNAME,CREATED_AT,PROFILE_IMAGE,BIO) values ('kong123','kong123@naver.com','$2b$10$S5XY8NFnlnROHKin6/vtcOi/gz6cYi6xNrFdIXIfvTfR7l1q6w07m','KILLKONG',to_date('26/06/02','RR/MM/DD'),'http://localhost:3010/uploads/profiles/1780971131431-1780812961615-스크린샷 2026-06-06 153804.png','코딩 재미없어');
Insert into USERS (USER_ID,EMAIL,PASSWORD_HASH,NICKNAME,CREATED_AT,PROFILE_IMAGE,BIO) values ('user01','ironwater@naver.com','$2b$10$LtuEZz0GM.A8okKPYm0hK.HJzaN6xXJ1ro2oYnvKOvBR2wNc9eWxu','김절절절수',to_date('26/06/02','RR/MM/DD'),'http://localhost:3010/uploads/profiles/1780970682167-1780812804043-스크린샷 2026-05-01 125158.png','물 아끼세요 여러분~~');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "BOOKMARKS" MODIFY ("BOOKMARK_ID" NOT NULL ENABLE);
  ALTER TABLE "BOOKMARKS" MODIFY ("USER_ID" NOT NULL ENABLE);
  ALTER TABLE "BOOKMARKS" MODIFY ("POST_ID" NOT NULL ENABLE);
  ...
  ALTER TABLE "BOOKMARKS" ADD CONSTRAINT "UK_BOOKMARK" UNIQUE ("USER_ID", "POST_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "COMMENTS" MODIFY ("POST_ID" NOT NULL ENABLE);
  ALTER TABLE "COMMENTS" MODIFY ("USER_ID" NOT NULL ENABLE);
  ALTER TABLE "COMMENTS" MODIFY ("CONTENT" NOT NULL ENABLE);
  ALTER TABLE "COMMENTS" MODIFY ("CREATED_AT" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "FOLLOWS" MODIFY ("FOLLOWER_ID" NOT NULL ENABLE);
  ALTER TABLE "FOLLOWS" MODIFY ("FOLLOWING_ID" NOT NULL ENABLE);
  ALTER TABLE "FOLLOWS" ADD CONSTRAINT "CHK_SELF_FOLLOW" CHECK (FOLLOWER_ID <> FOLLOWING_ID) ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "POSTS" MODIFY ("CREATED_AT" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "POST_LIKES" MODIFY ("POST_ID" NOT NULL ENABLE);
  ALTER TABLE "POST_LIKES" MODIFY ("USER_ID" NOT NULL ENABLE);
  ALTER TABLE "POST_LIKES" ADD PRIMARY KEY ("LIKE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "POST_LIKES" ADD CONSTRAINT "UQ_POST_USER_LIKE" UNIQUE ("POST_ID", "USER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "POST_TAGS" MODIFY ("POST_ID" NOT NULL ENABLE);
  ALTER TABLE "POST_TAGS" MODIFY ("TAG_ID" NOT NULL ENABLE);
  ALTER TABLE "POST_TAGS" ADD PRIMARY KEY ("POST_TAG_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "POST_TAGS" ADD CONSTRAINT "UK_POST_TAGS" UNIQUE ("POST_ID", "TAG_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "USERS" MODIFY ("PASSWORD_HASH" NOT NULL ENABLE);
  ALTER TABLE "USERS" MODIFY ("NICKNAME" NOT NULL ENABLE);
  ALTER TABLE "USERS" MODIFY ("CREATED_AT" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "BOOKMARKS" ADD CONSTRAINT "FK_BOOKMARK_USER" FOREIGN KEY ("USER_ID")
	  REFERENCES "USERS" ("USER_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "BOOKMARKS" ADD CONSTRAINT "FK_BOOKMARK_POST" FOREIGN KEY ("POST_ID")
	  REFERENCES "POSTS" ("POST_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table COMMENTS
--------------------------------------------------------

  ALTER TABLE "COMMENTS" ADD CONSTRAINT "FK_COMMENTS_POST" FOREIGN KEY ("POST_ID")
	  REFERENCES "POSTS" ("POST_ID") ON DELETE CASCADE ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "FOLLOWS" ADD CONSTRAINT "FK_FOLLOWER" FOREIGN KEY ("FOLLOWER_ID")
	  REFERENCES "USERS" ("USER_ID") ENABLE;
  ALTER TABLE "FOLLOWS" ADD CONSTRAINT "FK_FOLLOWING" FOREIGN KEY ("FOLLOWING_ID")
	  REFERENCES "USERS" ("USER_ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "POST_LIKES" ADD CONSTRAINT "FK_LIKE_POST" FOREIGN KEY ("POST_ID")
	  REFERENCES "POSTS" ("POST_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "POST_LIKES" ADD CONSTRAINT "FK_LIKE_USER" FOREIGN KEY ("USER_ID")
	  REFERENCES "USERS" ("USER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table POST_TAGS
--------------------------------------------------------

  ALTER TABLE "POST_TAGS" ADD CONSTRAINT "FK_POST_TAGS_POST" FOREIGN KEY ("POST_ID")
	  REFERENCES "POSTS" ("POST_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "POST_TAGS" ADD CONSTRAINT "FK_POST_TAGS_TAG" FOREIGN KEY ("TAG_ID")
